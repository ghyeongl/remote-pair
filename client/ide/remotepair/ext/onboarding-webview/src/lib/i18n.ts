...
const EN: Dict = {
  ...
  "map.desc": "Mount host folders on this computer, or pair folders for two-way sync.",
  ...
  "map.mountDesc": "Mount a host folder on this computer. The local mount location is managed for you.",
  "map.syncDesc": "Use when the same folder already exists on both sides via a third-party sync tool (e.g. Google Drive, Dropbox). Pick the matching folder on the host and on this computer.",
  ...
  "map.localUnsupported": "Type an absolute local path, such as /Users/you/project, C:\\Users\\you\\project, or \\\\server\\share.",
  "map.localPathInvalid": "Enter an absolute local path.",
...
const KO: Dict = {
  ...
  "map.title": "폴더 매핑",
  "map.desc": "호스트 폴더를 이 컴퓨터에 마운트하거나 폴더를 양방향 동기화하세요.",
  ...
  "map.mountDesc": "호스트 폴더를 이 컴퓨터에 마운트합니다. 로컬 마운트 위치는 자동으로 관리됩니다.",
  "map.syncDesc": "구글 드라이브·드롭박스 등 서드파티 도구로 이미 양쪽에 같은 폴더가 존재할 때 사용합니다. 호스트와 이 컴퓨터 양쪽에서 대응되는 폴더를 선택하세요.",
  ...
  "map.localUnsupported": "로컬 절대 경로를 입력하세요. 예: /Users/you/project, C:\\Users\\you\\project, \\\\server\\share",
  "map.localPathInvalid": "로컬 절대 경로를 입력하세요.",
