...
const EN: Dict = {
  ...
  "map.hostManualHint": "The tree shows examples — type your real host folder path if it is not listed. It is verified on the host when you save.",
  "map.cancel": "Cancel",
...
const KO: Dict = {
  ...
  "map.selected": "선택됨:",
  "map.hostManualHint": "트리는 예시입니다 — 목록에 없으면 실제 호스트 폴더 경로를 입력하세요. 저장할 때 호스트에서 검증됩니다.",
  "map.cancel": "취소",
