...
export function WizardShell({
  ...
  return (
    <div className="flex h-screen w-screen flex-col bg-card shadow-[0_20px_50px_-12px_rgba(15,23,42,0.15)]">
      <div className="flex-1 overflow-y-auto px-10 pb-8 pt-10">
        {children}
      </div>
